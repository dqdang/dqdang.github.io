...
Even though we failed here, we ended 3rd place in the tournament overall, which exceeded expectations. In the future, we may revisit this idea and implement it.
